...
$db_n="id11548551_society_db";
  //isdbarrExists($con,array("college"));
    ...
    IfNotcreatetbl($con,"news_details",$coln,$coldisc);
        ...
        $coldisc=array("int auto_increment,primary key($coln[0])","varchar(30)","varchar(30)","varchar(30)","varchar(30)","varchar(30)");
    ...
    IfNotcreatetbl($con,"complaints_details",$coln,$coldisc);
        ...
        $coln=array("pd_id","uid","method","doneby","datee","topic","amt");
        $coldisc=array("int auto_increment,primary key($coln[0])","varchar(30)","varchar(30)","varchar(30)","varchar(30)","varchar(30)","int" );
